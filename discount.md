...
<p>기존 회원·과거 무료 체험 이용자·앱스토어 또는 플레이스토어 결제 이력 보유자는 <strong>친구 추천·프로모션 링크 혜택 대상에서 제외될 수 있다</strong>고 스픽 공식 안내에 명시되어 있습니다. 재결제를 고려하신다면 링크 접속 후 결제 화면에서 실제 적용 금액이 어떻게 표시되는지 반드시 확인해보시는 것이 좋습니다.</p>
...
<p>먼저 <strong>웹사이트에서 결제 중인지</strong> 확인하세요. 앱 내 결제와 웹 결제는 표시 금액이 다를 수 있습니다. 웹인데도 할인이 반영되지 않았다면 브라우저 캐시·쿠키를 삭제하거나 시크릿 모드에서 전용 링크로 다시 접속해보시는 편이 좋습니다. 이미 스픽 이용 이력이 있는 계정은 링크 대상에서 제외될 수 있으니, 이 경우 링크 유의사항을 확인하시고 필요하면 스픽 고객센터에 문의해보시는 것도 방법입니다.</p>
