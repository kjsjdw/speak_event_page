...
<p>
스픽은 강의를 보기만 하는 영어 학습이 아니라, 직접 말하기 연습까지 자연스럽게 이어지도록 설계된 영어 회화 앱입니다.
</p>

<div class="learning-step">
  <div class="step-content">
    <h3>Step 1. 상황별 원어민 '진짜 표현' 학습</h3>
    <p>교과서에만 나오는 딱딱한 표현이 아니라, 원어민이 실제로 자주 사용하는 표현과 문장 패턴을 짧은 비디오 강의로 만나보실 수 있습니다.
      길고 어려운 문법 설명보다 실제 대화 상황을 먼저 보여 주기 때문에, 영어가 낯선 분들도 흐름을 따라가기 훨씬 편합니다.</p>
  </div>
...
<div class="learning-step">
  <div class="step-content">
    ...
    <p>스픽의 가장 큰 특징은 직접 말하는 연습량이 많다는 점입니다.
      눈으로 보기만 하는 것이 아니라 한 문장을 여러 번 소리 내어 말하도록 구성되어 있어, 입이 자연스럽게 문장을 기억하도록 도와줍니다.
      음성 인식 기반 피드백으로 발음과 표현을 바로 확인해 보실 수 있어, 혼자서 연습하셔도 방향을 잡기 쉽습니다.</p>
  </div>
  <div class="step-media">
    <video autoplay loop muted playsinline preload='metadata' >
...
<div class="learning-step">
  <div class="step-content">
    ...
    <p>배운 내용을 실제 상황에서 써먹을 차례입니다. 사람 앞에서 영어로 말할 때는 긴장되셨던 분들도, 평가하지 않는 AI 튜터와는 훨씬 편하게 연습하실 수 있습니다. 어떤 주제로 말을 꺼내도 AI가 자연스럽게 대화를 이어 가며, 더 자연스러운 표현이 필요할 때는 즉시 교정도 해줍니다.</p>
  </div>
  <div class="step-media">
    <video autoplay loop muted playsinline preload='metadata' >
...
[
  {
    ...
    "@type": "VideoObject",
    "@id": "{{ page.url | absolute_url }}#video-step1",
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "VideoObject",
    "@id": "{{ page.url | absolute_url }}#video-step2",
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "VideoObject",
    "@id": "{{ page.url | absolute_url }}#video-step3",
